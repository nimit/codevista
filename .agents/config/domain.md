...
- **`.agents/adr/`** - read ADRs that touch the area you're about to work in. In multi-context repos, also check `.agents/context/<context>/adr/` for context-scoped decisions.
